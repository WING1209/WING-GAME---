...
let isOpponentSkippedTurn = false;
...
function displayBattleRulesDesc() {
    ...
    let guestMsg = document.getElementById('guest-wait-host-msg');
...
function createJankenOverlayDOM() {
    ...
    document.getElementById('btn-janken-rock').onclick = () => chooseJanken('rock');
    document.getElementById('btn-janken-scissors').onclick = () => chooseJanken('scissors');
    document.getElementById('btn-janken-paper').onclick = () => chooseJanken('paper');
    
    document.getElementById('btn-role-first').onclick = () => selectFirstOrSecond('first');
    document.getElementById('btn-role-second').onclick = () => selectFirstOrSecond('second');
}
...
function executeOpponentAction(data) {
    ...
    isOpponentSkippedTurn = activeItemsUsed.includes(2);
...
function createRouletteOverlayDOM() {
    ...
    document.getElementById('btn-stop-roulette').onclick = () => stopItemRoulette();
}
...
function createColorChangeOverlayDOM() {
    ...
    BASE_COLORS.forEach(col => {
        ...
        srcBtn.onclick = () => handleColorChangeStep1(col, srcBtn);
        ...
        dstBtn.onclick = () => handleColorChangeStep2(col);
        dstContainer.appendChild(dstBtn);
    });

    document.getElementById('btn-cancel-cc').onclick = () => {
